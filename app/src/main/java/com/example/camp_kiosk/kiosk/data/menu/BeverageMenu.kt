...
import com.example.camp_kiosk.kiosk.BEVERAGE_MENU_DESCRIPTION
import com.example.camp_kiosk.kiosk.BEVERAGE_MENU_NAME
import com.example.camp_kiosk.kiosk.data.edible.Edible
import com.example.camp_kiosk.kiosk.data.payment.PaymentInfo

class BeverageMenu(
    name: String = BEVERAGE_MENU_NAME,
    description: String = BEVERAGE_MENU_DESCRIPTION,
